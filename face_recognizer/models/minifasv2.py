"""MiniFASNet V2 SE — anti-spoofing architecture with MobileNetV4-style blocks.

Copyright @ facenox - Face Antispoof Onnx
    https://github.com/facenox/face-antispoof-onnx
Vendored with modifications.

Backbone: depth-wise separable convolutions with Squeeze-and-Excitation
          (MobileNetV4-style, ~1.8M parameters).
Input:    (B, 3, 80, 80) float32.
Output:   2-class logits [spoof, real].
"""
